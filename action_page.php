...
$stmt = mysqli_prepare($con, "INSERT INTO user_table (Id, Name_user, Ip, Bios, Os, Sql_answer, Output_device, Programming_languages, Linkedin_owner, Giving_pledge, Cyber_threats, Ram, Iphone_year, Virus, Garage_companies, It_acronym, Creator, Date_user) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
